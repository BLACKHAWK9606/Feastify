...
<head>
    ...
    <link rel="icon" href="#">
    <title>GOOD FOOD FOR A GOOD MOOD</title>
    <!-- Bootstrap core CSS -->
        ...
        <section class="hero bg-image" data-image-src="images/img/main.jpeg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    ...
                    <h5 class="font-white space-xs">Hundreds of flavors under one roof</h5>
                    </div>
                    <div class="steps">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>We"ve got your covered with menus from delivery restaurants online.</p>
                                </div>
                            </div>
                        </div>
															...
															<div class="row">
																...
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	...
																	<div class="bottom-part">
																		<div class="cost"><i class="fa fa-check"></i> Min Ksh 10,00</div>
